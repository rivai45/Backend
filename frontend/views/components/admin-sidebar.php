<?php /** Admin Sidebar Component */ ?>
<aside class="admin-sidebar" id="adminSidebar">
  <a href="<?= BASE_URL ?>?page=admin/dashboard" class="admin-sidebar-brand">
  ...
  <nav class="admin-sidebar-nav">
    <a href="<?= BASE_URL ?>?page=admin/dashboard" class="<?= $adminPage==='dashboard'?'active':'' ?>">
    ...
    <a href="<?= BASE_URL ?>?page=admin/booking" class="<?= $adminPage==='booking'?'active':'' ?>">
    ...
    <a href="<?= BASE_URL ?>?page=admin/properti" class="<?= $adminPage==='properti'?'active':'' ?>">
    ...
    <a href="<?= BASE_URL ?>?page=admin/anggota" class="<?= $adminPage==='anggota'?'active':'' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
      <?= __('admin.members') ?>
    </a>
    <a href="<?= BASE_URL ?>?page=admin/pendapatan" class="<?= $adminPage==='pendapatan'?'active':'' ?>">
    ...
    <a href="<?= BASE_URL ?>?page=admin/pengaturan" class="<?= $adminPage==='pengaturan'?'active':'' ?>">
